...
function buildSystemPrompt(inputKind: ProfileInputKind) {
  ...
  return [
    ...
    domainLine,
    allowedLine,
    "Blockiere Eigenschaften, Geschmacksprofile, reine Zubereitungsarten, Preis-/Portionswuensche, Naehrwertziele, Stimmungen, universelle Kuechenbasics und allgemeine Gewuerz-/Wuerzungsbegriffe.",
